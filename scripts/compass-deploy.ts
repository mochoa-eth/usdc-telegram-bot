...
function usage(): string {
  return [
    ...
    '  DEPLOYER_PRIVATE_KEY set in .env; bun run compass:deploy SimpleToken --signer private-key --mode live --blockchain ARC-TESTNET --compass-chain Arc_Testnet --rpc https://rpc.testnet.arc.network',
